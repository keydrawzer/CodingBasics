...
public class ProductService
{
    ...
    public List<ProductsModel>? GetAll()
    {
        try
        {
            var result = _connection.GetResultsFromQuery<ProductsModel>("SELECT ProductID, Name, ProductModel, CultureID, Description FROM [Production].[vProductAndDescription]", Map);           
            return result;
        }
        catch (Exception ex)
        {
