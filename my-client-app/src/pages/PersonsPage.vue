<template>
	<div class="persons-page">
		...
		<search-box :dropdownOptions="['IN', 'EM', 'SP', 'SC', 'VC', 'GC']" dropdownLabel="Search by Person Type:"
			@searchByName="searchByNameAndType" @searchBySelection="searchByNameAndType" />
